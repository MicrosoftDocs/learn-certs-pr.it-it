---
title: Informazioni sugli esami on-line | Microsoft Docs
description: Informazioni sugli esami on-line 
...
---
# Informazioni sugli esami on-line

Puoi sostenere qualsiasi esame on-line basato sui ruoli o sugli elementi di base (rilasciato da Pearson VUE) comodamente da casa o in ufficio mentre sei monitorato da un supervisore tramite webcam e microfono. (Questo articolo non riguarda gli esami erogati da Certiport.) Se sei interessato a sostenere un esame online tramite Pearson VUE e vuoi capire meglio cosa aspettarti prima di registrarti, questa pagina spiegherà i dettagli. Puoi anche guardare il video [YouTube video](https://youtu.be/Gm1PqdbwBP0) di Pearson VUE.


## Fai un test di sistema

Fai un test di sistema ora per vedere se il tuo computer e il luogo sono compatibili con il software di monitoraggio online e poi fissa la data del tuo esame.

[Test di sistema ora](https://service.proctorcam.com/system_test?customer=pearson_vue&clientcode=MICROSOFT)
...
**ATTENZIONE! Prima di registrarti per un esame on-line:**

1. **Completa il [test di sistema](https://service.proctorcam.com/system_test?customer=pearson_vue&clientcode=MICROSOFT) richiesto sullo stesso computer e nella stessa postazione da cui effettuerai il test.**  
2. **Conferma che il tuo ID è conforme (leggi i [requisiti](https://home.pearsonvue.com/Policies/1S/English)) e che il nome nel tuo profilo corrisponda esattamente alla tua identificazione.**  
3. **Controlla i requisiti tecnici, di sistema, ambientali e di protocollo di prova riportati di seguito.**
...
Potrebbe essere necessario configurare il software di protezione e antivirus di Internet affinché ignori il file eseguibile di Pearson Secure Browser.
...
<table style="border:0px;">
    <tbody>
        ...
        <tr>
            <td>
                <p><strong>Firewall</strong></p></td><td><p>Non sostenere l'esame in un ambiente con un firewall aziendale (inclusa la VPN) o avvisa il tuo amministratore di rete sui requisiti di configurazione della rete.</p>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <p>Su Windows verifica che l'audio e il microfono non siano disattivati.</p><p class="">Gli utenti Mac potrebbero dover morire l'autorizzazione a OnVUE all'interno di "Preferenze di Sistema: Sicurezza & Privacy: Privacy" per il microfono, la telecamera, l'automazione e il monitoraggio degli input.</p>
            </td>
        </tr>
        <tr>
            <td>
...
[Leggi i requisiti per la risoluzione dei problemi a livello di amministratore di rete](https://home.pearsonvue.com/op/OnVUE-min-specs-Network-Admin-Requirements)

Prima di registrarti e acquistare il tuo esame, completa il [test di sistema](https://service.proctorcam.com/system_test?customer=pearson_vue&clientcode=MICROSOFT) richiesto sullo stesso computer e nella stessa postazione da cui effettuerai il test.
...
## Test del protocollo di sessione
...
Il nome sulla carta di identità deve corrispondere al nome immesso nel profilo Microsoft e Pearson VUE.
...
- Non è possibile copiare o registrare domande o risposte dall'esame con qualsiasi mezzo e non è possibile condividere o discutere le domande o le risposte visualizzate nell'esame con altri.
- Sostenendo questo esame, sei a conoscenza che il supervisore ti monitorerà continuamente tramite video e audio durante l'esame stesso, e sei a conoscenza e acconsenti alla registrazione audio e video del tuo viso, della tua voce, della stanza in cui ti trovi e della posizione durante l'effettuazione dell'esame. Riconosci di non avere diritto alla privacy nel luogo in cui svolge l'esame e rinunci a qualsiasi reclamo inerente alla privacy. Se non desideri essere registrato (video o audio), devi avvisare immediatamente il supervisore di non intendere procedere con l'esame.
...
## Registrati per un esame online
...
- Per registrarti, seleziona l'esame on-line Microsoft che desideri sostenere dall' [elenco degli esami](/learn/certifications/browse/), quindi seleziona il pulsante **Pianifica esame**. Se nel tuo paese sono disponibili gli esami online, potrai selezionare tale opzione durante il processo di registrazione all'esame. Selezionerai anche la lingua del software di benvenuto, del supervisore e del software di supervisione.
...
- Assicurati di disporre dei diritti amministrativi sul computer in modo da poter scaricare il software della prova.
...
**Nota** È possibile dover attendere fino a cinque minuti prima di connettersi con un presentatore.

Una volta in contatto con il presentatore:

- Tieni a disposizione la patente di guida, il passaporto o altri documenti identificativi riconosciuti per consentire la verifica della tua identità.
- Il presetatore esaminerà le regole di comportamento del test, l'ambiente di test e il processo di comunicazione durante l'effettuazione dell'esame. Tutte le comunicazioni con il presetatore e il supervisore saranno condotte nella lingua selezionata durante la registrazione (questa potrebbe essere diversa dalla lingua in cui si sta sostenendo l'esame).
- Ti verrà chiesto di chiudere tutte le applicazioni non essenziali (come e-mail o chat).
...
Se si verifica un problema tecnico durante l'esame, il supervisore tenterà di contattarti prima tramite chat. Se la chat non funziona, il supervisore ti contatterà al telefono.

Se a seguito dell'esame si verifica un problema tecnico, puoi contattare Pearson VUE. Tieni a portata di mano il numero del report eventi imprevisti fornito dal supervisore.
