...
2. Criteri per la ripetizione degli esami di certificazione Microsoft Technology Associate (MTA) e Microsoft Certified Educator (MCE)
    ...
    5. Se si raggiunge un punteggio sufficiente in un esame MTA, non è possibile sostenerlo nuovamente.
...
4. Criteri per la ripetizione degli esami MCP Beta
...
**Per sostenere un esame di certificazione Microsoft in un centro di testing Pearson VUE in India, Cina o Pakistan, è necessario essere residenti nei rispettivi paesi. Se si è residenti in uno di questi paesi, tenere in considerazione quanto segue:**
...
A causa delle leggi sulla privacy in Slovenia, Pearson VUE non può fornire esami online controllati ai candidati che vivono in Slovenia o che hanno la cittadinanza slovena. Questi candidati possono sostenere gli esami presso un Test Center Pearson VUE (PVTC).

- I candidati che _risiedono_ in Slovenia, avarnno solo l'opzione del Test Center nel programmare un esame.

- I candidati che risiedono al di fuori della Slovenia possono vedere il Proctoring online come un'opzione di test disponibile, ma non saranno in grado di completare con successo l'esame quando presenteranno l'identificazione della cittadinanza slovena (passaporto o altri documenti) come prova. Questi candidati devono programmare un esame presso un Test Center Pearson VUE (PVTC).
...
Si noti che i posti sono limitati e disponibili in base all'ordine di arrivo e che, per motivi di sicurezza, gli esami beta non sono disponibili in Cina, India, Pakistan o Turchia.

A titolo di ringraziamento per la partecipazione al processo beta, il candidato riceverà un voucher di sconto del 25% da Pearson VUE circa 6 settimane prima che l’esame venga reso disponibile sul web. Questi voucher vengono forniti da VUE ed inviati per posta elettronica all’indirizzo indicato al momento della registrazione. Se non si riceve il voucher di sconto del 25% entro 6 settimane dalla data in cui l’esame viene reso disponibile sul web, è possibile inviare un messaggio e-mail a [pvamericascustomerservice@pearson.com](mailto:pvamericascustomerservice@pearson.com).

## Prezzi accademici degli esami

I prezzi degli esami Microsoft Certified Professional (MCP) per gli studenti sono disponibili nella maggior parte dei paesi (a eccezione di India e Cina).
...
2. **POLITICA RELATIVA AL COMPORTAMENTO DEI CANDIDATI**
    ...
    - Adottare qualsiasi altro comportamento improprio che possa compromettere la riservatezza, l'integrità o la sicurezza dell'esame.
...
- Passaggio 2: Registrati tramite la [Microsoft Certification Dashboard](https://www.microsoft.com/learning/dashboard.aspx)
...
- Per ulteriori informazioni, vedi: [Microsoft Exam and Certification Badges](https://www.microsoft.com/learning/badges.aspx)
...
- Se non ci si presenta all'appuntamento dell'esame o se l'appuntamento non viene modificato né annullato almeno 24 ore prima dell'appuntamento programmato, si perde l'intera tassa dell'esame. I giorni feriali sono dal lunedì al venerdì, senza includere le vacanze globali di Pearson VUE.

La riprogrammazione o la cancellazione dell'appuntamento per l'esame programmato può essere effettuata tramite il [Dashboard di certificazione](https://microsoft.com/learning/dashboard).
...
| ------------- |:-------------:| -----:|
| Esami Associate ed Expert basati sui ruoli      | 150 minuti | 180 minuti |
...
Gli esami di certificazione Microsoft sono disponibili in diverse lingue. Tuttavia, i candidati che devono sostenere l'esame in inglese invece che nella propria lingua di origine possono richiedere del tempo aggiuntivo per completarlo. L'approvazione del tempo aggiuntivo viene fornita caso per caso. Puoi richiedere sistemazioni speciali per il test a [Pearson VUE](http://www.pearsonvue.com/accommodations/pv_review.asp?clientName=Microsoft) o [Certiport](http://www.certiport.com/portal/desktopdefault.aspx?page=common/pagelibrary/Disabilities.htm).

**Quali sono i servizi disponibili per i disabili?**

Microsoft ha l'obiettivo di assicurare che gli esami siano accessibili a tutti, anche ai disabili. Per un elenco delle sistemazioni disponibili, visitare la [pagina relativa alle sistemazioni speciali](http://www.pearsonvue.com/accommodations/).
...
Microsoft si impegna ad assicurare che un qualche tipo di materiale di formazione sia disponibile per tutte le competenze misurate durante gli esami. È possibile trovare un elenco di queste risorse nella pagina dei dettagli dell'esame.
...
Poiché non si viene penalizzati per le risposte errate e gli esami contengono alcuni elementi per i quali non è possibile rivedere o modificare la tua risposta, è buona norma rispondere a ogni domanda prima di passare alla successiva. Segnare le domande per la revisione per tornarvi se possibile.
...
Se non si riesce a visualizzare il rapporto del punteggio online o non lo si riceve entro due settimane dalla data definitiva di pubblicazione dell’esame, è possibile rivolgersi al fornitore dell’esame per sapere quando saranno elaborati i risultati. Se hai domande sulla tua trascrizione, ti preghiamo di contattare [Certification Support](https://aka.ms/mcpforum).
...
Inoltre, spesso si ritiene che rispondendo correttamente al 70% delle domande si superi l'esame perché il punteggio minimo da ottenere è 700. Tuttavia, si tratta di un punteggio scalato. La percentuale effettiva di domande a cui bisogna rispondere correttamente varia da esame a esame e può essere superiore o inferiore al 70%, a seconda dell'input fornito dagli esperti del settore che hanno contribuito all'impostazione del punteggio minimo durante lo sviluppo dell'esame e il supporto in itinere nonché la difficoltà delle domande dell'esame.
...
Se si supera un esame, significa che si è dimostrato le competenze necessarie nel dominio di pertinenza. Inoltre, i punteggi dei candidati che hanno superato l'esame non possono essere confrontati per determinare se un candidato è più competente di un altro: punteggi più alti non significano livelli più alti di competenza. Lo stesso vale per i candidati che non superano un esame: punteggi più bassi non significano livelli più bassi di competenza. Superare un esame significa aver dimostrato le proprie competenze indipendentemente dal punteggio, non superarlo significa non averle dimostrate.
...
Se ritieni che una domanda di un Microsoft Certification exam sia imprecisa, puoi richiedere una valutazione di tale domanda utilizzando la [procedura di contestazione a un elemento di un esame](#policies-5) entro 30 giorni di calendario dalla data da cui è stato sostenuto l’esame. Il processo di valutazione aiuta Microsoft a identificare e correggere le domande problematiche e ad aggiornare gli esami di conseguenza.
...
Il programma di certificazione Microsoft richiede che i candidati accettino le condizioni di un accordo di non divulgazione (NDA) prima di sostenere un esame. L'accordo di non divulgazione (NDA) richiede che i candidati mantengano riservate le informazioni relative al contenuto degli esami. La firma di un accordo di non divulgazione è un'ulteriore misura adottata per garantire la regolarità degli esami di certificazione Microsoft e l'integrità del programma di certificazione Microsoft, nonché per scoraggiare eventuali forme di pirateria legate al contenuto degli esami e al relativo utilizzo non autorizzato.

**Cosa si intende per violazione?**

Per violazione si intende qualsiasi attività fraudolenta che consenta a un candidato non qualificato di superare un esame. Questo tipo di comportamento illecito influisce in modo negativo sull'integrità del programma di certificazione Microsoft.
...
Se Microsoft ritiene che un candidato abbia falsificato un report di valutazione, il candidato perderà qualsiasi possibilità di sostenere esami Microsoft in futuro e le relative certificazioni potrebbero essere revocate.
...
Se si ritiene che un sito Web o un'azienda fornisca servizi di esame tramite intermediari, è necessario informare subito Microsoft inviando un messaggio di posta elettronica a [mlsecure@microsoft.com](mailto:mlsecure@microsoft.com).

**Cosa si intende per "brain dump"? Sono legali?**

Un "brain dump", in relazione a esami per certificazioni, è una fonte, ad esempio un sito Web, che raccoglie contenuti degli esami di certificazione ottenuti in modo fraudolento allo scopo di condividerli o venderli ai candidati. Il contenuto presente nei "brain dump" è esattamente lo stesso o molto simile a quello dell'esame. Poiché il contenuto dell'esame è stato ottenuto in modo fraudolento, l'utilizzo di questo tipo di materiale per la preparazione o durante un esame è considerato una violazione. Chi fornisce "brain dump" viola i diritti di proprietà intellettuale e gli accordi di non divulgazione di Microsoft.
...
[Per visualizzare il video tutorial PBT, fare clic qui.](https://www.microsoft.com/en-us/videoplayer/embed/RE4ppkp)
...
Le attività sono valutate in base al risultato finale. Non ci interessa come il candidato esegue le attività (ad esempio tramite l'interfaccia utente (UI) o utilizzando i comandi di PowerShell), solo che l'attività venga completata correttamente. Completare l'attività come si farebbe normalmente; lo script di calcolo del punteggio valuta il risultato finale rispetto alle caratteristiche chiave per determinare se è stata eseguita correttamente. Ad esempio, se l'attività consiste nell'aggiungere un utente, lo script di calcolo del punteggio si assicura che l'utente sia stato aggiunto.
...
**Sono un docente. Posso ancora ricevere uno sconto accademico (nei paesi validi) per l'esame della mia certificazione Microsoft erogato da Pearson VUE?**
...
La documentazione che chiediamo serve a far capire al team di Pearson responsabile delle sistemazioni speciali la natura della tua disabilità. Pearson dispone di esperti in grado di determinare la sistemazione appropriata. La documentazione che fornisci ci permette di essere certi che la tua esperienza durante l’esame sia ottimale. Nel caso di dislessia, ad esempio, il disturbo può essere più o meno grave. Di conseguenza, la sistemazione viene adeguata in base al grado di gravità del disturbo descritto nella documentazione. La documentazione è fondamentalmente costituita da una valutazione ufficiale effettuata da un medico negli ultimi 5 anni. Un candidato che soffre di una lieve dislessia può aver bisogno di un tempo pari a 1,5 volte più lungo di quello della durata dell’esame, mentre a un candidato con un dislessia grave può essere concesso il doppio del tempo per completare l’esame oppure permesso di essere assistito da un’altra persona che legga per lui. L’obiettivo è far sì che la sessione di esame tenga conto delle necessità del candidato senza che ciò comprometta la validità e affidabilità della procedura di valutazione.

**La mia documentazione risale a più di 5 anni fa. Perché non la posso utilizzare per soddisfare i requisiti della documentazione?**

Le disabilità si evolvono nel tempo. perché le condizioni fisiche possono migliorare o peggiorare. Di conseguenza, la sistemazione fornita in base a documentazione obsoleta potrebbe non essere più appropriata. L’obiettivo di questa procedura è verificare che ai candidati con necessità speciali venga assegnata una sistemazione che permetta loro di godere di un’esperienza il più possibile equivalente a quella degli altri candidati durante l’esame, senza pregiudicare la validità e l’affidabilità della procedura di valutazione. Più aggiornata è la tua documentazione e maggiore è la probabilità che VUE ti assegni una sistemazione adatta alle tue esigenze.

**Uso un apparato acustico, una sedia a rotelle, un inalatore, ecc. Necessito di un’autorizzazione speciale per portare questi dispositivi nell’aula dell’esame?**

Questi dispositivi sono considerati ausili di sostegno e **non** richiedono un’approvazione preventiva. Gli ausili di sostegno saranno ammessi nell’aula di esame dopo che sono stati ispezionati visivamente dal personale del centro di testing. L’ispezione verrà effettuata esaminando il dispositivo senza toccarlo (o toccare il candidato) e senza chiedere al candidato di rimuovere il dispositivo, se non diversamente indicato [qui](https://home.pearsonvue.com/test-taker/Test-accommodations/Comfort-aids.aspx).
